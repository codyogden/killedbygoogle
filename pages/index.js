...
export default class HomePage extends Component {
    ...
    analytics() {
        if (process.env.NODE_ENV === 'production' )
            return (<script async defer data-website-id="87417ccb-e93c-4789-aad3-576d80124db8" src="https://analytics.bale.media/umami.js"></script>);
    }
        ...
        return (
            <>
                <Head>
                    ...
                    {this.analytics()}
                    <script async type="text/javascript" src="https://cdn.carbonads.com/carbon.js?serve=CK7I653N&placement=killedbygooglecom&placement=carbon" id="_carbonads_js"></script>
                </Head>
                <Header />
                <App />
                <Footer />
